...
import card_img from '../img/card_img.jpg'

function Card() {
  return (
    <div className='max-w-[12em] rounded overflow-hidden shadow-lg mt-5 mx-3'>
        <img className='max-h-[10em] w-full rounded-t-lg' src={card_img} alt="imagen detalle" />
        <div className='px-6 py-4 h-[13em]'>
            <h5 className='my-[1px] text-2xl font-bold tracking-tight text-gray-900 dark:text-white'>lorem lorem</h5>
